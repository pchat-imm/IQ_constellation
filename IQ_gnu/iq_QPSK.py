...
class iq_QPSK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "iq_QPSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("iq_QPSK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "iq_QPSK")
        ...
        4, 2, 2, 1, 1).base()
        self.CMA_alg = CMA_alg = digital.adaptive_algorithm_cma( qpsk, .0001, 4).base()
...
def main(top_block_cls=iq_QPSK, options=None):
